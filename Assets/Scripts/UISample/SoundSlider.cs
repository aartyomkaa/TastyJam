...
public class SoundSlider : MonoBehaviour
{
    ...
    {
        _mixerGroup.audioMixer.SetFloat("Music", Mathf.Lerp(-80, 20, _music.value));
    }
    public void SliderVolumeChange()
    {
        _mixerGroup.audioMixer.SetFloat("Effects", Mathf.Lerp(-80, 20, _volume.value));
    }
    public void SliderAmbientChange()
    {
        _mixerGroup.audioMixer.SetFloat("Ambient", Mathf.Lerp(-80, 20, _ambient.value));
    }
}
